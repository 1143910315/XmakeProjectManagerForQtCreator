...
XMakeAutoCompleter::XMakeAutoCompleter()
{
    setAutoInsertBracketsEnabled(true);
}

bool XMakeAutoCompleter::isInComment(const QTextCursor &cursor) const
{
...
bool XMakeAutoCompleter::isInString(const QTextCursor &cursor) const
{
...
QString XMakeAutoCompleter::insertMatchingBrace(const QTextCursor &cursor,
                                                const QString &text,
                                                QChar lookAhead,
                                                bool skipChars,
...
QString XMakeAutoCompleter::insertMatchingQuote(const QTextCursor &cursor,
                                                const QString &text,
                                                QChar lookAhead,
                                                bool skipChars,
                                                int *skippedChars) const
...
int XMakeAutoCompleter::paragraphSeparatorAboutToBeInserted(QTextCursor &cursor)
{
...
bool XMakeAutoCompleter::contextAllowsAutoBrackets(const QTextCursor &cursor,
...
bool XMakeAutoCompleter::contextAllowsAutoQuotes(const QTextCursor &cursor, const QString &textToInsert) const
{
    if (textToInsert.isEmpty())
        return false;
...
bool XMakeAutoCompleter::contextAllowsElectricCharacters(const QTextCursor &cursor) const
{
