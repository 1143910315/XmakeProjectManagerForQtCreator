...
public:
            ...
            std::unique_ptr<MesonProjectNode> takeProjectNode() {
                return std::move(m_rootNode);
            }

            const BuildOptionsList &buildOptions() const {
                return m_parserResult.buildOptions;
            };
            const TargetsList &targets() const {
                return m_parserResult.targets;
            }
            const QStringList &targetsNames() const {
                return m_targetsNames;
            }
            ...
            void setQtVersion(Utils::QtMajorVersion v) {
                m_qtVersion = v;
            }
