...
class XMakeIndenter final : public TextEditor::TextIndenter
{
public:
    explicit XMakeIndenter(QTextDocument *doc)
...
bool XMakeIndenter::isElectricCharacter(const QChar &ch) const
{
...
int XMakeIndenter::indentFor(const QTextBlock &block,
                             const TextEditor::TabSettings &tabSettings,
