...
public:
            ...
            const QHash<QString, Utils::Link> &cmakeSymbolsHash() const {
                return m_cmakeSymbolsHash;
            }
            CMakeKeywords projectKeywords() const {
            ...
            const QHash<QString, Utils::Link> &dotCMakeFilesHash() const {
                return m_dotCMakeFilesHash;
            }
