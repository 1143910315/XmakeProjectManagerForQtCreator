    ...
    , m_presetsTempDir("qtc-xmake-presets-XXXXXXXX")
{
    useTemporaryKitAspect(XMakeKitAspect::id(),
                               [this](Kit *k, const QVariantList &vl) { cleanupTemporaryXMake(k, vl); },
                               [this](Kit *k, const QVariantList &vl) { persistTemporaryXMake(k, vl); });
    ...
    if (importPath.isChildOf(m_presetsTempDir.path())) {
        ...
        if (buildConfigurationTypes.front().isEmpty()) {
            ...
            if (!buildConfigurationTypesString.isEmpty()) {
                ...
                for (int type = XMakeBuildConfigurationFactory::BuildTypeDebug;
        ...
        for (const auto &buildType : buildConfigurationTypes) {
            ...
            if (type == XMakeBuildConfigurationFactory::BuildTypeDebug
                || type == XMakeBuildConfigurationFactory::BuildTypeProfile)
